...
namespace Backend.Migrations
{
    ...
    [Migration("20250407224732_InitialSqlServerMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserDrink", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("FavoriteDrinksDrinkId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUserId", "FavoriteDrinksDrinkId");

                    b.HasIndex("FavoriteDrinksDrinkId");

                    b.ToTable("UserFavoriteDrinks", (string)null);
                });
            ...
            modelBuilder.Entity("ApplicationUserDrink", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Drink", null)
                        .WithMany()
                        .HasForeignKey("FavoriteDrinksDrinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
