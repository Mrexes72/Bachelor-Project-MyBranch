...
const EditMenuItemModal = ({ isOpen, onClose, onSubmit, menuItem, handleInputChange, categories }) => {
    ...
    return (
        <div className="modal">
            <div className="modal-content-menu-management">
                ...
                <p className="modal-description">Update the menu item details below</p>
                <form onSubmit={onSubmit} className="add-menu-item-form">
                    ...
                    <div className='modal-actions'>
                        <button type="submit" className="add-button-menu-management">Save Changes</button>
                        <button className="cancel-button-menu-management" onClick={onClose}>Cancel</button>
                    </div>
                </form>
            </div>
        </div>
